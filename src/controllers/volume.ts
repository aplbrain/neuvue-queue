...
export default class VolumeController extends mix(Controller).with(CRUDMixin) {
    ...
    public attachTo(root: string, server: Server, options?: VolumeControllerOptions): void {
        if (root.endsWith("/")) {
