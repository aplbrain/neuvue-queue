...
export default class NodeController extends mix(Controller).with(CRUDMixin, DecidableMixin) {
    ...
    public attachTo(root: string, server: Server, options?: NodeControllerOptions): void {
        if (root.endsWith("/")) {
